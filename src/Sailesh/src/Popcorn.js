...
const Popcorn = () => {
  return (
    <div className="cover">
      <div className="head">
        <div>Share <br /> Popcorn</div>
      </div>
      <div className="Iconlist">
        <div className="star"></div><br />
        <div className="favourite"></div><br />
        <input className="body" type="text" placeholder="Get Recommendation" /><br />
        <div className="vectoricon"></div><br />
